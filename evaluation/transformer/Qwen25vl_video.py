...
def build_pos_content(video_path, background9, background19, pos, gt_frame_number, bk_frame_number, video_dir):
    if pos[:2] == "10":
        ...
        if pos_num == int(pos[:2]):
            ...
            background_list = list(background9.keys())[0]
...
def pos_inference(
    ...
    content1, content2 = build_pos_content(video_path, background9, background19, pos, frame_number, bk_frame_number, video_dir)
    ...
    pos_num = int(pos[-2:])
    if pos_num != 10:
        video_input_background = video_inputs
        video_inputs = torch.cat([video_input_background[:pos_num*frame_number], video_inputs[0], video_input_background[pos_num*frame_number:]], dim=0)
